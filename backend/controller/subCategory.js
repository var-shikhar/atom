...
const postSubCategory = async (req, res) => {
    const { name, description, categoryID, taxSlab } = req.body;
    try {
...
const getInitSubCategory = async (req, res) => {
    ...
    try {
        ...
        const subCategoryDetail = {
            ...
            taxSlab: subcategory.categoryTax,
        };
...
const putSubCategory = async (req, res) => {
    const { id, name, description, categoryID, taxSlab } = req.body;
    try {
        ...
        subCat.categoryTax = taxSlab || subCat.categoryTax;
