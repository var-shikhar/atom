...
const couponFormValidation = Yup.object().shape({
    couponCode: Yup.string()
        .matches(/^[A-Z0-9]*$/, 'Coupon code must only contain letters and numbers')
        .min(3, 'Coupon Code must be at least 3 characters')
        .max(20, 'Coupon Code can be at most 20 characters')
    ...
    limitUsage: Yup.number().notRequired(),
