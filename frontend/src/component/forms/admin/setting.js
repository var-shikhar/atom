            ...
            {({ errors, touched, dirty, isValid }) => {
                return (
                    <Form className='row rounded border shadow-lg p-4 m-2'>
                        ...
                        <FormGroup className='col-12 col-md-6'>
                            <FormLabel htmlFor="taxSlab">Category Tax</FormLabel>
                            <Field
                                name="taxSlab"
                                type="number"
                                placeholder='5%'
                                ...
                                max={100}
                                as={FormControl}
                                isInvalid={!!(errors.taxSlab && touched.taxSlab)}
                            />
                            <ErrorMessage name="taxSlab" component="div" className="invalid-feedback" />
                        </FormGroup>
                        <FormGroup className='col-12'>
